...
// const nombre = document.querySelector(".contact_input-nombre");
// const email = document.querySelector(".contact_input-email");
// const asunto = document.querySelector(".contact_input-asunto");
// const mensaje = document.querySelector(".contact_input-mensaje");